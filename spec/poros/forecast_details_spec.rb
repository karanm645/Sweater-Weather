...
RSpec.describe Forecast do 
  describe 'initialize' do 
    ...
    it 'creates forecast details' do 
      ...
      expect(forecast.current_weather).to have_key(:weather)
      ...
      expect(forecast.daily_weather.first).to have_key(:temp)
      #has both description and icon
      expect(forecast.daily_weather.first).to have_key(:weather)

      expect(forecast.hourly_weather).to be_an Array
      expect(forecast.hourly_weather.first).to have_key(:dt)
      expect(forecast.hourly_weather.first).to have_key(:temp)
      #has description and icon 
      expect(forecast.hourly_weather.first).to have_key(:weather)
    end 
